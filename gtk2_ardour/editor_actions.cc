...
Editor::register_actions ()
{
	...
	*/
	...
	act = ActionManager::register_toggle_action (editor_actions, "show-editor-list", _("Show Editor List"), sigc::mem_fun (*this, &Tabbable::list_button_toggled));
	ActionManager::session_sensitive_actions.push_back (act);
	list_attachment_button.set_related_action (act);

	act = ActionManager::register_toggle_action (editor_actions, "show-editor-mixer", _("Show Editor Mixer"), sigc::mem_fun (*this, &Tabbable::strip_button_toggled));
	ActionManager::session_sensitive_actions.push_back (act);
	strip_attachment_button.set_related_action (act);

	act = ActionManager::register_toggle_action (editor_actions, "show-editor-props", _("Show Editor Properties Box"), sigc::mem_fun (*this, &Tabbable::props_button_toggled));
	ActionManager::session_sensitive_actions.push_back (act);
